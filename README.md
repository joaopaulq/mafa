...
## Contents
* [**LU**](https://github.com/joaopaulq/mafa/blob/master/src/qr.lu): **L** is a lower triangular or trapezoidal matrix with unit diagonal, **U** is an upper triangular or trapezodial matrix with pivots on the diagonal.
